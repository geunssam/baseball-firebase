...
export const LAST_UPDATED = '2025년 10월 31일';

// 서비스 운영자 정보
export const SERVICE_OPERATOR = {
  serviceName: '야구 스코어보드 (Firebase 버전)',
  name: '이원근',
  email: 'zoomwk432@gmail.com',
  school: '초등학교', // 필요시 학교명 입력
};
...
나. 학생 (학생 코드 입력)
   ...
   • 활동 기록: 경기 참여 기록, 안타/득점/수비 통계, 배지 획득 내역
   • 자동 수집 항목: 로그인 일시

다. 법정대리인 정보 (만 14세 미만 학생)
...
※ 개인정보 침해에 대한 신고나 상담이 필요한 경우 아래 기관에 문의하실 수 있습니다:
  ...
  },
  {
    ...
    content: `본 서비스는 만 14세 미만 아동의 개인정보를 수집·이용합니다.

가. 법정대리인 동의
   • 만 14세 미만 아동의 개인정보를 수집하는 경우 법정대리인(부모 또는 보호자)의 동의가 필요합니다.
   • 교사는 학생 등록 시 법정대리인의 동의를 받았음을 확인해야 합니다.

나. 법정대리인의 권리
   • 아동의 개인정보 열람, 정정, 삭제, 처리정지 요구
   • 아동의 개인정보 수집·이용 동의 철회

다. 보호 조치
   • 학생 개인정보는 교육 목적으로만 사용됩니다.
   • 학생은 본인의 기록만 조회할 수 있으며, 다른 학생의 정보는 볼 수 없습니다.
   • 학생 개인정보는 교사만 관리할 수 있습니다.

라. 동의 확인 방법
   • 교사가 학생 등록 시 "법정대리인의 동의를 받았음"을 체크박스로 확인
   • 필요 시 법정대리인의 이름과 연락처를 기록`,
  },
  {
    id: 'changes',
...
만 14세 미만 학생의 경우 법정대리인(부모)의 동의가 필요합니다.
`;
